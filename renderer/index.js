...
ipcRenderer.on('verinfo', () => {
  ...
  fetch("https://raw.githubusercontent.com/ProCrafters-MC-Automation/ProCraftersBot/main/VERSION", { method: 'GET' })
...
function opengithub() {
  shell.openExternal('https://github.com/ProCrafters-MC-Automation/ProCraftersBot')
}
//restore user data
function setData() {
