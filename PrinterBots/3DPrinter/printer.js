...
bot.on('login', () => {
    console.log(`${process.argv[2]} logged in ${process.argv[3]}!`)
})
    ...
    if (message === 'print') {
        ...
        function nearbyBlocks(position) {
            ...
            allblocks.forEach(element => {
                ...
                if (difference(element.coords.x + startX, position.x) < process.argv[6] - 0.5 && difference(element.coords.y + startY, position.y) < process.argv[6] - 0.5 && difference(element.coords.z + startZ, position.z) < process.argv[6] - 0.5) {
