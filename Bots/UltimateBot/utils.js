const { GoalNear, GoalFollow, GoalBlock, Movements, goals } = require('mineflayer-pathfinder').goals
let mcData;
...
const behaviours = {
    ...
    info: (bot, messageParts) => { //TODO: This comment
        // console.log(bot.health.toString())
    ...
    goToTarget: (bot, target, movement, dist = 0, cb) => {
        ...
        bot.pathfinder.setMovements(movement);
        movement.scaffoldingBlocks = ["dirt", "cobblestone"]
        const goal = new GoalBlock(p.x, p.y, p.z, dist);
