...
import index_1 from "../src/index.ts";
import { projectileGravity } from "@nxg-org/mineflayer-trajectories";
...
var KillBot = /** @class */ (function () {
    function KillBot(num) {
        ...
        this.handler = function (username, message) {
            return __awaiter(_this, void 0, void 0, function () {
                var split;
                var _this = this;
                return __generator(this, function (_a) {
        ...
        var moves = new Movements(this.bot, this.bot.registry);
        ...
        this.bot.on("entityMoved", function (entity) {
            return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (!defend)
                        return [2 /*return*/];
                    if (!Object.keys(projectileGravity).includes(entity.name))
                        return [2 /*return*/];
