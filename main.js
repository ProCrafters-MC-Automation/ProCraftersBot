...
const options = {
    ...
    username: process.argv[6] ? process.argv[7] : 'PvPBot',
...
if (process.argv.length < 4 || process.argv.length > 8) {
    console.log('Usage : node main.js <host> <port> [<disableWeb>] [<version>] [<name>] [<name of the owner>] [<password>]')
    process.exit(1)
}
